    ...
    <div class="w-[460px] bg-white/90 backdrop-blur-md p-10 rounded-xl shadow-lg border border-white/20">
      ...
      <div class="mb-6">
        ...
        <div v-if="loginMethod === 'phone'" class="space-y-4 transition-all duration-300">
          ...
          <div class="space-y-4">
            <div class="relative">
              <input v-model="captcha" type="text" placeholder="请输入验证码" class="w-full px-4 py-3 border border-gray-200 rounded-button text-sm pl-4 focus:border-primary">
              <button 
      ...
      <div class="text-center">
        ...
        <a href="#" class="text-sm text-primary hover:text-primary/80 ml-2" @click="handleRegister">立即注册</a>
        <span class="text-sm text-gray-400 mx-2">|</span>
        <a href="#" class="text-sm text-primary hover:text-primary/80" @click="handleFindPassword">找回密码</a>
      </div>
    </div>
